      ...
      <div className="w-full max-w-md px-6 py-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <div className="px-6 py-6 border-b border-gray-50 bg-gray-50/50">
            <h1 className="text-xl font-bold text-brand-gray">Supply Request Review</h1>
            ...
            {request.status !== "PENDING" && (
              <div className="pt-6 space-y-6">
                ...
                <div className="text-center">
                  <p className="text-brand-gray/50 font-medium italic">This request has been {request.status.toLowerCase()}.</p>
                  <Link href="/" className="inline-block mt-4 text-brand-red font-bold hover:underline">
                    Back to Form
                  </Link>
                </div>
              </div>
