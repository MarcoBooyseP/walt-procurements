...
import { approveRequest, denyRequest, referToDirector } from "@/actions/request";
              ...
              <div className="pt-4 space-y-6">
                <form action={async (formData: FormData) => {
                  ...
                  if (action === "approve") {
                    ...
                    await referToDirector(request.id, comment);
                  } else {
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      Approve Request (Bypass Director)
                    </button>
                    ...
                    <button 
                      ...
                      name="action" 
                      value="refer"
                      className="w-full py-5 bg-blue-600 text-white font-bold rounded-xl shadow-md hover:bg-blue-700 active:scale-95 transition-all text-lg flex items-center justify-center gap-2"
                    >
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
