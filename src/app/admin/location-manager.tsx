...
import { addLocation, deleteLocation } from "./location-actions";
          ...
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-sm overflow-hidden relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-gray-700 ml-1">Location Name</label>
                <input
                  name="name"
                  required
                  autoFocus
